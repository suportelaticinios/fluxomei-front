  ...
  <main class="p-6" id="page-content">
        <div class="bg-white p-6 rounded-2xl shadow-sm w-full">
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="space-x-2">
                    <button id="openModalBtn" class="bg-emerald-800 text-white px-4 py-2 rounded hover:bg-emerald-700">Nova entrada</button>
  ...
  <div id="entryModal" class="hidden fixed inset-0 bg-black opacity-90 flex items-center justify-center z-50 p-4">
    <div class="bg-white rounded-lg shadow-lg w-full max-w-lg">
      ...
      <div class="flex justify-between items-center border-b border-gray-200 p-4">
        <h3 class="text-lg font-semibold text-emerald-700">Nova entrada</h3>
      ...
      <div class="p-4 space-y-4">
        <div>
          ...
          <input type="date" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-1 focus:ring-green-700">
        </div>  
        <div>
        ...
        <div>
          ...
          <input type="text" placeholder="Ex: Venda A" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-1 focus:ring-green-700">
        </div>
        <div>
